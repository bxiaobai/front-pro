...
import CreateModal from "@/pages/Ir/Seat/components/CreateModal";
import UpdateModal from "@/pages/Ir/Seat/components/UpdateModal";
    ...
    return (
      <>
        ...
        <InfoModal
          ...
          oldData={currentRow}
          roomName={allRoom?.find(item => item.id === currentRow?.irId)?.irName}
          onCancel={() => {
