            ...
            title={
              <div>
                <Flex gap={36} justify={'flex-end'} align={'center'}>
                  <div style={{ width: '30%' }}>预约日期</div>
                  <div style={{ width: '70%', display: 'flex', justifyContent: 'flex-end' }}>
                    <ProForm<API.RoomVO> submitter={false} form={form} layout={'inline'}>
                      <ProFormSelect
                        name="id"
                        label="输液室"
                        width={'sm'}
          ...
          <Card className={styles.time} title={'选择预约时间'}>
            <Flex gap={36}>
              <Flex vertical style={{ width: '40%' }}>
                <AppointmentList
                  appointments={sourcePoolOptions}
                  onSelectAppointments={handleAppointmentsSelect}
                />
              </Flex>
